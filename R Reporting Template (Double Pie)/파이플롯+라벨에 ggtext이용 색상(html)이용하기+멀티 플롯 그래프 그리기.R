...
ggPie(data=browsers,aes(pies=browser,count=share), title = 'Title') + legend()

# 데이터 형태.
k = c('1점', '2점', '3점', '4점', '5점', '6점')
tot = c(10,33,24,20)
EN = c(10,20,30,50,40,30)
KR = c(15,18,22,64,32,40)
...
ggPieDonut(data, aes(x = c(cat,k), y=line),labelposition=0)
